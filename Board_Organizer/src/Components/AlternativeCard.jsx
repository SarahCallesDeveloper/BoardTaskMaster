...
function CardValues({ card, onEdit }) {
...
function CardEditing({ editedTitle, setEditedTitle, editedDescription, setEditedDescription, editedDueDate, setEditedDueDate, editedTags, setEditedTags, handleAddTag, editedAssignedMembers, setEditedAssignedMembers, handleAddMember, handleRemoveTag, handleRemoveMember, handleSave, onCancel }) {
  return (
            ...
            <div className="card">
              {isEditing ? (
                <CardEditing
                  ...
                  editedAssignedMembers={editedAssignedMembers}
                  setEditedAssignedMembers={setEditedAssignedMembers}
                ...
                <CardValues card={card} onEdit={handleEdit} />
              )}
            </div>
          </div>
        </div>
